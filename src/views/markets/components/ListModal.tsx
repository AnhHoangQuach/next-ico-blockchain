...
export default function ListModal({ type, nft, isListing, onList, ...props }: IProps) {
      ...
      <ModalContent py="30px">
        ...
        <ModalBody>
          <Flex alignItems="center" w="full" direction="column">
            <Image src={nft?.image} alt={nft?.name} borderRadius="20px" w="80%" mb="20px" />
            <Flex w="full" direction="column">
              <Text fontWeight="bold">
                {' '}
                {type === 'LISTING' ? 'Price listing: ' : 'Reserve price'}{' '}
              </Text>
              <Text fontSize="12px" fontStyle="italic" color="rgba(255,255,255,0.5)">
                Set your price:
              </Text>
              <Flex w="full" my="10px">
                <Input
